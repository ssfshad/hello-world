...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::content::error_note_list,
            commands::content::error_note_save,
            commands::content::error_note_hit,
            commands::content::error_note_delete,
            commands::content::glossary_list,
            commands::content::glossary_save,
            commands::content::glossary_delete,
            commands::content::week_review_get,
            commands::content::week_review_save,
            commands::content::week_focus,
            commands::content::getting_started,
            ...
            commands::practice::problem_hint_prompt,
